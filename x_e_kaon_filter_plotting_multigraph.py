...
# this code plot a spectrogram of energy for only charged kaons and also
# makes a ratio plot for the ratio of the energy spectrum of charged kaons
# for mlevelmax4 / mlevelmax 0. the code also does this same thing for just 
# charged kaons formed from recombination. it plots all 4 plots on the same
# plot. 
...
kaon_particle_id = (321, -321) # kaon+, kaon-
...
filtered_particles_ALL_0 = particle_species(particles0, kaon_particle_id)
filtered_particles_ALL_4 = particle_species(particles4, kaon_particle_id)
...
fig.suptitle(r'$x_{E}$ spectrum and Ratio Plot for Charged kaons from Recom')
fig.tight_layout()
fig.savefig(f"x_e_spectrum_ratio_charged_kaons_multi_graph.png", dpi=600)
plt.close(fig)
