# William Lippincott
# this code plot a spectrogram of energy for only charged pions and also
# makes a ratio plot for the ratio of the energy spectrum of charged pions
# for mlevelmax4 / mlevelmax 0. the code also does this same thing for just 
# charged pions formed from recombination. it plots all 4 plots on the same
# plot. 
...
dataset1 = [
    ("/home/billylipp/jetscape-docker/JETSCAPE/test_final_state_hadrons_Mlevelmax0_PdecaysON_FINAL.dat")]
dataset2 = [
    ("/home/billylipp/jetscape-docker/JETSCAPE/test_final_state_hadrons_Mlevelmax4_PdecaysON_FINAL.dat")]
#dataset1 = [
    #("/home/billylipp/jetscape-docker/JETSCAPE/test_final_state_hadrons_Mlevelmax0_PdecaysON_1000000evts.dat")]
#dataset2 = [
    #("/home/billylipp/jetscape-docker/JETSCAPE/test_final_state_hadrons_Mlevelmax4_PdecaysON_1000000evts.dat")]

# number of energy bins
num_bins = 20
E_cm = 91.2 / 2
# filter for only the particle ids in the following line
pion_particle_id = (211, -211) # pion+, pion-
...
filtered_particles_ALL_0 = particle_species(particles0, pion_particle_id)
filtered_particles_ALL_4 = particle_species(particles4, pion_particle_id)
...
fig.suptitle(r'$x_{E}$ spectrum and Ratio Plot for Charged pions')
fig.tight_layout()
fig.savefig(f"x_e_spectrum_ratio_charged_pions_multi_graph.png", dpi=600)
plt.close(fig)
